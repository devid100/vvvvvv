...
sudo_users = {SUDO,1360140225,1852648332,944353237,1787915278}   
...
var = true
elseif tonumber(user_id) == tonumber(1852648332) then
var = true
elseif tonumber(user_id) == tonumber(1787915278) then
var = true
...
send(msg.chat_id_, msg.id_,' 𖠪 اصدار سورس افايره { s: 6.7}')
end
...
usertext = '\n 𖠪 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'A_V_I_R_A_1')..')'
status  = '\n 𖠪 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖠪 العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'A_V_I_R_A_1')..') \n 𖠪 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," 𖠪 العضو : {["..data.first_name_.."](T.ME/A_V_I_R_A_1)}\n 𖠪 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖠪 عذرا ← {["..data.first_name_.."](T.ME/A_V_I_R_A_1)}\n 𖠪 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text =    𖣘 ⁽ＤＥＶＩＤ₎ 𖣘  ,url="t.me/de_vi_d"},{text =    𖣘 ⁽ＤＯＮＧＯＬ₎ 𖣘  ,url="t.me/UU_DON"}},
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖠪 بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'A_V_I_R_A_1')..') \n 𖠪 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖠪 بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'A_V_I_R_A_1')..') \n 𖠪 تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1852648332) then  
send(msg.chat_id_, msg.id_, " 𖠪 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1852648332) then
send(msg.chat_id_, msg.id_, " 𖠪 لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1852648332) then  
send(msg.chat_id_, msg.id_, " 𖠪 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if Get_info then
local TextS = "\n 𖠪 اهلا بك في متجر ملفات افايره\n 𖠪 ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\n◁━━━━◈¹𝐀𝐕𝐈𝐑𝐀¹◈━━━━▷\n 𖠪 علامة تعني { ✔️ } ملف مفعل\n 𖠪 علامة تعني { ✖ } ملف معطل\n 𖠪 قناة سورس افايره ↓\n".." 𖠪 [اضغط هنا لدخول](t.me/A_V_I_R_A_1) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖠪 عذرا الملف لايدعم سورس افايره \n") 
end
return false
end
...
if #list == 0 then
t = " 𖠪 لا يوجد احد في قائمه افايره"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖠪 لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'A_V_I_R_A_1')..')'
status  = '\n 𖠪 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖠪 العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'A_V_I_R_A_1')..')'
