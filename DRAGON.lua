...
https.request("https://api.telegram.org/bot"..token..'/sendgif?chat_id=' .. msg.chat_id_ .. '&gif=https://t.me/A_V_I_R_A_1/522&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
